...
export const addUserProject = (data) => {
  return postData("add/user/project", data);
};

//获取用户绑定的项目
export const getUserProject = (data) => {
  return getData("user/project", data);
};
...
//用户价格管理修改价格
export const setUserPriceManage = (data) => {
  return getData("update/price", data);
};

// 今日不显示
export const setUpdateTime = (data) => {
  return getData("update/time", data);
};
...
// 获取联合项目列表
export const getjoint = (data) => {
  return getData("joint/list", data);
};

//创建联合项目
export const addjoint = (data) => {
  return postData("joint/add", data);
};
//删除联合项目
export const romvejoint = (data) => {
  return getData("joint/del", data);
};
